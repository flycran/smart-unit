...
:::warning Note
Reverse parsing only supports strings generated by or compatible with the [`format`](../api/index.md#format) method.
If you use [`getUnit`](../api/index.md#getunit) to get the unit and then manually format it, it's usually not supported.
:::
