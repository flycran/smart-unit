...
describe('Decimal input tests (high precision mode)', () => {
  ...
  it('should format Decimal values correctly', () => {
    expect(su.format(new Decimal('123456789012345678901234567890'))).toEqual('123456789012345.67890123456789Tm')
    expect(su.format(new Decimal('12345678901234567890.123456789'))).toEqual('12345.678901234567890123456789Tm')
  })
})
