...
const bigLength = new SmartUnit(
  ['mm', 1000, 'μm', 1000, 'nm', 1000, 'pm'],
  { useDecimal: true }
);

console.log('\n=== High Precision Examples ===');
console.log(bigLength.format('0.000001'));  // 1nm
console.log(bigLength.format('0.000000001')); // 1pm
...
console.log('\n=== Financial Examples ===');
console.log(currency.format('12345678901234567890')); // 12345678.9T
